...
defined("BASEPATH") OR exit('No direc script access allowe');

class Movies extends MY_Controller {

    public function ＿constract() {
        parent::__constract();
    ...
    public function type($slug = NULL) {
        ...
        if ($slug == 'serials') {
            ...
            $this->data['title'] = 'Сериалы' ; //pagination
    ...
    public function create() {
        ...
        if($this->input->post('slug') && $this->input->post('name') && $this->input->post('descriptions') && $this->input->post('year') 
        && $this->input->post('rating') && $this->input->post('poster') && $this->input->post('player_code') && $this->
        input->post('director') && $this->input->post('add_date') && $this->input->post('category_id')) {
    ...
    public function edit($zlug = NULL) {
        ...
        if($this->input->post('slug') && $this->input->post('name') && $this->input->post('descriptions') && $this->input->post('
            year') && $this->input->post('rating') && $this->input->post('poster') && $this->input->post('player_code') && $this->
            input->post('director') && $this->input->post('add_date') && $this->input->post('category_id')) {
            ...
            if($this->Films_model->updateMovies($id, $slug, $name, Sdescriptions, $year, Srating, $poster, Splayer_code, $director
                , $add_date, $category_id)) {
    ...
    public function delete($slug = NULL) {
        ...
        if($this->Films_model->deleteMovies($slug)) {
            $this->data['result'] = $this->data['movies_delete']['name'];
        }
